...
public class NaiveBayesClassificationVerification {

    //	static String DATA_PATH = "hdfs://localhost:9000/input/experiment2/测试数据.txt";
    static String DATA_PATH = "hdfs://localhost:9000/lab2/验证数据.txt";
    ...
    static String Classified_Result = "hdfs://localhost:9000/lab2/Classified_Validation_Result";
...
//			context.write(new Text(newSequence), value);
    ...
    public static void main(String[] arg) throws Exception{
        ...
        job.setJarByClass(NaiveBayesClassificationVerification.class);
